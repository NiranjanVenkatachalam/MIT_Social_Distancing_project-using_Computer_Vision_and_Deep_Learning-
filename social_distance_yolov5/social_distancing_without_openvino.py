...
class PeopleDetector:
    ...
    def draw_info(self, frame):
        ...
        latency = elapsed_time / self.frame_count

        # Draw FPS and latency text
        fps_text = f"FPS: {fps:.2f}"
        latency_text = f"Latency: {latency*1000:.2f} ms"
        frame = self.draw_text(frame, fps_text, (10, 60))
        frame = self.draw_text(frame, latency_text, (10, 80))
...
if __name__ == "__main__":
    ...
    if args.source == None:
        args.source = "inputs/street_area.mp4"
